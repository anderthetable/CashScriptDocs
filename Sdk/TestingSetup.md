...
>**CAUTION**
>
>The CashScript debugging tools only work with the [Simple Transaction Builder](/Sdk/Transactions.md). We plan to extend the debugging tools to work with the [Advanced Transaction Builder](/Sdk/TransactionsAdvanced.md) in the future.
