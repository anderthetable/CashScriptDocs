...
4. Next, go to the TransactionBuilder select the contract and the function to invoke it
...
>**TIP**
>
>To set up your CashScript developer environment, see the [Syntax Highlighting guide](/Guides/SintaxHighlighting.md).
...
Open your code editor to start writing your first CashScript smart contract. Then create a new file ``TransferWithTimeout.cash`` cand copy over the smart contracts code from below.
...
>**TIP**
>
>There are some other examples available on the [Examples page](/Languaje/Examples.md) that can be used to take inspiration from. Further examples of the TypeScript and JavaScript integration can be found on [GitHub](https://github.com/CashScript/cashscript/tree/master/examples).
