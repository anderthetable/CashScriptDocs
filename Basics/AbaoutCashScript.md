...
The CashScript syntax is based on Ethereum's smart contract language Solidity, but its functionality is very different since smart contracts on Bitcoin Cash differ greatly from smart contracts on Ethereum. You can read more on these differences on the [About Bitcoin Cash](/Basics/AbaoutBitcoinCash.md) page.
...
>**TIP**
>
>To see what kind of things can be built with CashScript, you can look at the [Showcase](/Showcase.md) or [Examples](/Languaje/Examples.md).
>
>To just dive into CashScript, refer to the [Getting Started page](GettingStarted.md)