...
To use the BCH WalletConnect signTransaction API, we need to pass a wcTransactionObj. CashScript TransactionBuilder has a generateWcTransactionObject method for creating this object.
