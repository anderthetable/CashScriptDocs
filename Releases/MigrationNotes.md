...
v0.7 to v0.8
cashc compiler
cashc is now a Pure ESM package. This means that you can no longer use require to import cashscript. For more information, see the ESM documentation.
...
CashScript SDK
cashscript is now a Pure ESM package. This means that you can no longer use require to import cashscript. For more information, see the ESM documentation.
